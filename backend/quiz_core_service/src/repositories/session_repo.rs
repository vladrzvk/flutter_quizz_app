use sqlx::PgPool;
use uuid::Uuid;
use crate::models::{SessionQuiz, ReponseUtilisateur};
...
impl SessionRepository {
    ...
    pub async fn find_active_by_id(pool: &PgPool, id: Uuid) -> Result<Option<SessionQuiz>, sqlx::Error> {
        sqlx::query_as::<_, SessionQuiz>(
    ...
    pub async fn update_score(pool: &PgPool, session_id: Uuid, points: i32) -> Result<(), sqlx::Error> {
    ...
    pub async fn finalize(pool: &PgPool, session_id: Uuid) -> Result<Option<SessionQuiz>, sqlx::Error> {
        sqlx::query_as::<_, SessionQuiz>(
            r#"

...
if ($LASTEXITCODE -ne 0) {
    Write-Host "ERROR: Generation cle CA" -ForegroundColor Red
    exit 1
}
...
if ($LASTEXITCODE -ne 0) {
    Write-Host "ERROR: Generation certificat CA" -ForegroundColor Red
    exit 1
}

Write-Host ""
Write-Host "SUCCESS: CA generee avec succes" -ForegroundColor Green
Write-Host ""
